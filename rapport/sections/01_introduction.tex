...
\begin{itemize}
    \item Une interface interactive permettant de visualiser les locaux via un plan cliquable, rendant l'expérience utilisateur plus intuitive[cite: 15]. Nous utiliserons pour cela les plans fournis au format vectoriel et PDF.
